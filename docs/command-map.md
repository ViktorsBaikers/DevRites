...
| Atomic workspace state | `state resolve`, `state close`, `migrate` | Go owns answer/drop/batch resolution, transactional close, and fail-closed v5 schema normalization. |
