...
`rite-*` skills Read `.agents/skills/devrites-lib/reference/standards/core.md` as their first step; the other 22
...
[`.agents/skills/devrites-lib/reference/standards/anti-patterns.md`](anti-patterns.md)**:
