...
**Failing case:** an **Unknown** outcome retried unchanged double-applies (duplicate charge, duplicate event). Idempotency: [`data-integrity.md`](data-integrity.md); outcome taxonomies: [`integration-reliability.md`](integration-reliability.md). Not provable → `cannot_verify` and stop.
