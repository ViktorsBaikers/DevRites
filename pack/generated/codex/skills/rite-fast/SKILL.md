...
| Role | Agent | Mode |
| --- | --- | --- |
| Planner: repo facts, draft spec and plan, ranked questions | [`fast-planner`](.codex/agents/fast-planner.toml) | read-only |
| Builder: slices and accepted fixes | [`fast-builder`](.codex/agents/fast-builder.toml) | write-capable, exact paths |
| Completeness checker | [`fast-checker`](.codex/agents/fast-checker.toml) | read-only |
| Critic: review and polish in one pass | [`fast-critic`](.codex/agents/fast-critic.toml) | read-only |
