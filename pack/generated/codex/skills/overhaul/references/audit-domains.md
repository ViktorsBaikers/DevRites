...
The craft role ([`overhaul-craft`](.codex/agents/overhaul-craft.toml)) examines the existing brief and
...
The boundary role ([`overhaul-boundary`](.codex/agents/overhaul-boundary.toml)) owns the live graph of
