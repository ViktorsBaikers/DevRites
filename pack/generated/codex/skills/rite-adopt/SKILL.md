...
**Step 0:** Read `.agents/skills/devrites-lib/reference/standards/core.md` first. Pull `documentation.md` when recording
...
## Workflow
0. **Read `.agents/skills/devrites-lib/reference/standards/core.md`**, then run the shared orientation preamble:
   ```bash
