...
- **Architecture + placement:** the layers and seams; where each kind of thing lives
  ...
  index if available (see `../../devrites-lib/reference/standards/tooling.md`) for
  structure, callers, and impact.
...
- Seed only what the code **and consistently** follows, not an aspiration, not a
