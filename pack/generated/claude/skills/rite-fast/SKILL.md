...
| Role | Agent | Mode |
| --- | --- | --- |
| Planner: repo facts, draft spec and plan, ranked questions | [`fast-planner`](../../agents/fast-planner.md) | read-only |
| Builder: slices and accepted fixes | [`fast-builder`](../../agents/fast-builder.md) | write-capable, exact paths |
| Completeness checker | [`fast-checker`](../../agents/fast-checker.md) | read-only |
| Critic: review and polish in one pass | [`fast-critic`](../../agents/fast-critic.md) | read-only |
