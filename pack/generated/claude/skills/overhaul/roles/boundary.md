# Role: boundary (contract and integration reviewer)
...
3. Check both sides per
   [`audit-domains.md`](../references/audit-domains.md#cross-layer-contracts): schema,
...
[`orchestration.md`](../references/orchestration.md#finding-proposals). A shared control
