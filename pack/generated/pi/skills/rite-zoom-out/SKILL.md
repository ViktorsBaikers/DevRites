...
Read `.pi/skills/devrites-lib/reference/standards/core.md` first: chiefly its existing-conventions
...
Apply `.pi/skills/devrites-lib/reference/standards/tooling.md`: use the primary
