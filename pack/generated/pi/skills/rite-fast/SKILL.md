...
| Role | Agent | Mode |
| --- | --- | --- |
| Planner: repo facts, draft spec and plan, ranked questions | [`fast-planner`](.pi/agents/fast-planner.md) | read-only |
| Builder: slices and accepted fixes | [`fast-builder`](.pi/agents/fast-builder.md) | write-capable, exact paths |
| Completeness checker | [`fast-checker`](.pi/agents/fast-checker.md) | read-only |
| Critic: review and polish in one pass | [`fast-critic`](.pi/agents/fast-critic.md) | read-only |
