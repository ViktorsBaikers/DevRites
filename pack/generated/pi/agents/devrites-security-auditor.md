...
`.pi/skills/devrites-lib/reference/standards/security.md` § AI / LLM features
...
- An analyzer result counts only after the installed-edition gate in
  `.pi/skills/devrites-lib/reference/standards/tooling.md` § Route by question type
...
- When scope is a surface larger than this diff — a subsystem, protocol surface, or
  repo sweep — apply `.pi/skills/devrites-lib/reference/standards/audit-coverage.md`
...
a blocking gap (`.pi/skills/devrites-lib/reference/standards/security.md`
