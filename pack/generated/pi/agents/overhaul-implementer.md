...
`.pi/skills/overhaul/references/scope-and-safety.md` § Executing target code,
...
Follow `.pi/skills/overhaul/references/repair-and-measurement.md` § One approved repair slice:
