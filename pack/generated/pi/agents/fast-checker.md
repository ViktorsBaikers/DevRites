...
Gap kinds and their meaning are in `.pi/skills/rite-fast/reference/check-and-triage.md`
(`.pi/skills/rite-fast/reference/check-and-triage.md` on Codex). Read it first.
