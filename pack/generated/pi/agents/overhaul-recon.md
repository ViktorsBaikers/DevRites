...
4. Discover components per
   `.pi/skills/overhaul/references/stack-profiles.md` § Discover components: manifests,
...
5. Assign lanes by responsibility and runtime, not by folder name
   (`.pi/skills/overhaul/references/orchestration.md` § Lanes by responsibility); mark
