...
Before reviewing, read the rules in `.pi/skills/devrites-lib/reference/standards/`
(`.pi/skills/devrites-lib/reference/standards/` on Codex): [`code-review.md`](../skills/devrites-lib/reference/standards/code-review.md),
