...
6. Classify every observation as engineering requirement, accessibility or platform
   ...
   (`.pi/skills/overhaul/references/audit-domains.md` § Classifying frontend guidance).
   Record `finished_at`.
...
`.pi/skills/overhaul/references/orchestration.md` § Finding proposals. Aesthetic
