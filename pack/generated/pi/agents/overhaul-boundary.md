...
3. Check both sides per
   `.pi/skills/overhaul/references/audit-domains.md` § Cross-layer contracts: schema,
...
`.pi/skills/overhaul/references/orchestration.md` § Finding proposals. A shared control
