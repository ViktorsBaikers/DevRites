...
| `repair-verify` | Does the fix hold, including neighboring failure modes, and does the new test still fail against the old implementation in a disposable baseline copy? |
