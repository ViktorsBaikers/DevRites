...
The craft role ([`overhaul-craft`](.omp/agents/overhaul-craft.md)) examines the existing brief and
...
The boundary role ([`overhaul-boundary`](.omp/agents/overhaul-boundary.md)) owns the live graph of
