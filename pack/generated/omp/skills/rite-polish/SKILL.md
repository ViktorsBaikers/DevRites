...
0. **Read** `.omp/skills/devrites-lib/reference/standards/core.md` first (the always-on operating rules). The
   ...
   `.omp/skills/devrites-lib/reference/standards/browser-proof-checklist.md`.
