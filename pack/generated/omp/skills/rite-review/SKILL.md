...
0. Read `.omp/skills/devrites-lib/reference/standards/core.md` first (the always-on operating rules); pull the
...
1. Read `spec.md`, `tasks.md`, `state.md`, `decisions.md`, `evidence.md`,
   ...
   questions, apply `.omp/skills/devrites-lib/reference/standards/tooling.md`: use
