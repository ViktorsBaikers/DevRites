...
(trigger `workflow-artifacts` — only when a workspace declares them). Before classifying any Reslice, read `.omp/skills/devrites-lib/reference/standards/acceptance-preserving-reslice.md`.
