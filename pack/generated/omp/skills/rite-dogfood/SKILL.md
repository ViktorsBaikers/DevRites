...
## Rules consulted
Step 0: Read `.omp/skills/devrites-lib/reference/standards/core.md`, then [`tooling.md`](../devrites-lib/reference/standards/tooling.md), [`testing.md`](../devrites-lib/reference/standards/testing.md), and [`afk-hitl.md`](../devrites-lib/reference/standards/afk-hitl.md) when relevant.
