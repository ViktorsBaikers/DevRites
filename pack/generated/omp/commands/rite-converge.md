...
---
Read and follow the DevRites skill `skill://rite-converge` (`.omp/skills/rite-converge/SKILL.md`). Apply it to these arguments, or to the current request when they are empty: $ARGUMENTS
