...
Gap kinds and their meaning are in `.omp/skills/rite-fast/reference/check-and-triage.md`
(`.omp/skills/rite-fast/reference/check-and-triage.md` on Codex). Read it first.
