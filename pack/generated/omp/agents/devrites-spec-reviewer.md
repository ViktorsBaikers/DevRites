...
Apply `.omp/skills/devrites-lib/reference/standards/agents.md` § **Result
admission** (Codex: the `.omp/skills/` mirror). Compare one feature diff with
...
Packet rules: `.omp/skills/devrites-lib/reference/standards/agents.md` § Independence
...
Read `.omp/skills/devrites-lib/reference/standards/spec-grammar.md` first
