...
3. Check both sides per
   `.omp/skills/overhaul/references/audit-domains.md` § Cross layer contracts: schema,
...
`.omp/skills/overhaul/references/orchestration.md` § Finding proposals. A shared control
