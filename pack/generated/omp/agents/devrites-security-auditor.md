...
`.omp/skills/devrites-lib/reference/standards/security.md` § AI / LLM features
...
- An analyzer result counts only after the installed-edition gate in
  `.omp/skills/devrites-lib/reference/standards/tooling.md` § Route by question type
...
a blocking gap (`.omp/skills/devrites-lib/reference/standards/security.md`
