...
- **Context to read yourself:** `spec.md`, `plan.md`, `decisions.md`, `assumptions.md`,
  ...
  `.omp/skills/rite-polish/reference/anti-ai-slop.md`, and `design-brief.md` when the slice is UI.
...
1. **ORIENT.** Before editing, read the target files and their neighbors. Learn the
   ...
   `.omp/skills/devrites-lib/reference/standards/tooling.md` for placement,
