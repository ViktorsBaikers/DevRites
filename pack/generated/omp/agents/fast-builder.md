...
- Rules to apply, from `.omp/skills/devrites-lib/reference/standards/`
  (`.omp/skills/devrites-lib/reference/standards/` on Codex): [`coding-style.md`](../skills/devrites-lib/reference/standards/coding-style.md),
