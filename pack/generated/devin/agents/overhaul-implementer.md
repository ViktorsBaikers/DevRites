...
`.devin/skills/overhaul/references/scope-and-safety.md` § Executing target code,
...
Follow `.devin/skills/overhaul/references/repair-and-measurement.md` § One approved repair slice:
