...
4. Discover components per
   `.devin/skills/overhaul/references/stack-profiles.md` § Discover components: manifests,
...
5. Assign lanes by responsibility and runtime, not by folder name
   (`.devin/skills/overhaul/references/orchestration.md` § Lanes by responsibility); mark
