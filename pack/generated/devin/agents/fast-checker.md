...
Gap kinds and their meaning are in `.devin/skills/rite-fast/reference/check-and-triage.md`
(`.devin/skills/rite-fast/reference/check-and-triage.md` on Codex). Read it first.
