...
- Rules to apply, from `.devin/skills/devrites-lib/reference/standards/`
  (`.devin/skills/devrites-lib/reference/standards/` on Codex): [`coding-style.md`](../skills/devrites-lib/reference/standards/coding-style.md),
