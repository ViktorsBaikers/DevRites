...
6. Classify every observation as engineering requirement, accessibility or platform
   ...
   (`.devin/skills/overhaul/references/audit-domains.md` § Classifying frontend guidance).
   Record `finished_at`.
...
`.devin/skills/overhaul/references/orchestration.md` § Finding proposals. Aesthetic
