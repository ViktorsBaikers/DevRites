# Role: frontend-engineer (frontend engineering reviewer)
...
2. Confirm the profile predicates: framework, router, compiler and bundler versions
   ...
   [`stack-profiles.md`](../references/stack-profiles.md); never apply a rule whose
...
3. Read every assigned range fully, then its callers and consumers. Apply the
   ...
   [`audit-domains.md`](../references/audit-domains.md#frontend-engineering) plus the
