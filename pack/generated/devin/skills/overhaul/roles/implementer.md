# Role: implementer (frontend or backend remediation implementer)
...
Follow [`repair-and-measurement.md`](../references/repair-and-measurement.md#one-approved-repair-slice):
