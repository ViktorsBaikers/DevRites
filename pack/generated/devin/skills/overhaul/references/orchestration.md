...
| Lane | Owns | Agent |
| --- | --- | --- |
| Frontend engineering | Client correctness, state/data flow, component architecture, framework idioms, client security, frontend performance and tests (web, native, desktop, game UI) | [`overhaul-frontend-engineer`](.devin/agents/overhaul-frontend-engineer.md) |
