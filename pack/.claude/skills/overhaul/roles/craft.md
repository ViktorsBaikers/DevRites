# Role: craft (frontend design, interaction and accessibility reviewer)
...
6. Classify every observation as engineering requirement, accessibility or platform
   ...
   ([`audit-domains.md`](../references/audit-domains.md#classifying-frontend-guidance)).
   Record `finished_at`.
...
[`orchestration.md`](../references/orchestration.md#finding-proposals). Aesthetic
