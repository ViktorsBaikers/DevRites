...
2. Confirm the profile predicates: framework, router, compiler and bundler versions
   ...
   `.claude/skills/overhaul/references/stack-profiles.md`; never apply a rule whose
...
3. Read every assigned range fully, then its callers and consumers. Apply the
   ...
   `.claude/skills/overhaul/references/audit-domains.md` § Frontend engineering plus the
