...
`.claude/skills/rite-review/reference/security-review.md`
([`security-review.md`](../skills/rite-review/reference/security-review.md) mirror on Codex).
...
denial evidence (`.claude/skills/devrites-lib/reference/standards/security.md`
