...
- Rules to apply, from `.claude/skills/devrites-lib/reference/standards/`
  (`.agents/skills/devrites-lib/reference/standards/` on Codex): [`coding-style.md`](../skills/devrites-lib/reference/standards/coding-style.md),
